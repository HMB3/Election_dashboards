...
DV_server_data           <- '//SVRANALYTICS1/AnalyticsReports/LG2001 Dashboard/Data/DecVoting/'
...
#removing these for ease of debugging.
# zz <- file(paste0(server_messages, 'DecVoting_messages.txt'), open = "wt")
...
# No tables from common data generator are needed
