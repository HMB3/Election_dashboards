----GO
---CREATE VIEW [Views].[BallotTrackStatusByDistrict]
----AS
SELECT AREA.Area_Code, BT.* FROM [Staging].EMS_VW_EventAreaAuthorityLGWardIan AREA
LEFT JOIN (SELECT * FROM (
		SELECT CONSIGNMENT.LGACode, CONTAINERSTATUS.StatusStage, count(*) as TotalCount FROM DV_Staging_BallotTrack_2021.dbo.NSW_Container CONTAINER
