...
PPDM_consignment       <- read_excel('G:/Election Events/LGE 2020 Programme/AP09 Data Management/21 Deliverables/02 Base data and PPDM/LG2101_PPDM_v1.xlsx',
                                     sheet = 'Consignment') %>% as.data.frame()
