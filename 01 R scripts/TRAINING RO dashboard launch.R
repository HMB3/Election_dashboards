...
data_files       <- paste0(root_dashboard, '02 Source data/RO Training')
...
source(paste0(script_files, 'Dashboard Opening Database Connections.R'))
source(paste0(data_gen,'09_01 TRAINING RO Ops Data Generator.R'))


## do everything that needs to be done, with existing data already run.
source(paste0(data_proc, '09_01 TRAINING RO Ops data processor.R'))
